...
import {Contract} from './moduledemo.model';
...
export class ModuleGridPrimengComponent extends Base implements OnInit {
    ...
    edit() {
        ...
        this.submitted = false;
        this.item = <Contract> JSON.parse(JSON.stringify(this.selectedItems));
