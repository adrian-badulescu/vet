...
import {Categorie} from './moduledemo.model';
...
export class ModuleTreePrimengComponent extends Base implements OnInit {
    ...
    edit() {
        ...
        this.submitted = false;
        this.item = <Categorie> JSON.parse(JSON.stringify(this.selectedItems[0].data));
