...
import { BnkAccI } from './bnkacc.model';
import { AccountsService } from './accounts.service';
import { BaseService } from '../../_services/base.service';

@Component({
    templateUrl: 'accounts.component.html',
    providers: [EwoService, BaseService, AccountsService]
})
export class AccountsComponent extends Base implements OnInit {
    ...
    list: BnkAccI[];
    columns: any[];
    item: BnkAccI = new BnkAccI();
    selectedItems: BnkAccI[];
    value: Date;
    ...
    ngOnInit() {
        this.service.entity = this.entityapi = 'bankaccounts';
    ...
    edit() {
        ...
        this.submitted = false;
        this.item = <BnkAccI>JSON.parse(JSON.stringify(this.selectedItems));
