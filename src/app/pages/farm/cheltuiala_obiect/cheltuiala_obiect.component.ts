...
import { cheltuialaObiectCls } from './cheltuiala_obiect.model';
...
@Component({
  selector: 'app-cheltobj',
  templateUrl: './cheltuiala_obiect.component.html',
  styleUrls: ['./cheltuiala_obiect.component.scss'],
  providers: [EwoService, BaseService]
})
export class CheltuialaObiectComponent extends Base implements OnInit {
  @ViewChild('tabset', { static: false }) tabset: TabsetComponent;
  breadCrumbItems: Array<{}>;
  selection: string;


  list: cheltuialaObiectCls[];
  columns: any[];
  item: cheltuialaObiectCls = new cheltuialaObiectCls();
  selectedItems: cheltuialaObiectCls[];
  value: Date;
  ...
  Object: Array<string> = ['A', 'B', 'C'];
  stocking: Array<string> = ['A', 'B', 'C'];
  Qty2: Array<string> = ['Bucati', 'Kg', 'Litri'];
  ...
  ngOnInit() {
    this.service.entity = this.entityapi = 'cheltuieliobj';
    this.validationform = this.formBuilder.group({
      id: [''],
      category: ['', [Validators.required]],
      object: ['', [Validators.required]],
      capitExpence: ['', [Validators.required]],
      deprecationPeriod: ['', [Validators.required]],
      qty: ['', [Validators.required]],
      qty2: ['', [Validators.required]],
      stocking: ['', [Validators.required]],
      grossVal: ['', [Validators.required]],
      unitPrice: ['', [Validators.required]],
      discount: ['', [Validators.required]],
      netPrice: ['', [Validators.required]],
      discountVal: ['', [Validators.required]],
      totalNetVal: ['', [Validators.required]]
    });
  ...
  add() {
    ...
    this.item = new cheltuialaObiectCls();
  ...
  edit() {
    ...
    this.submitted = false;
    this.item = JSON.parse(JSON.stringify(this.selectedItems)) as cheltuialaObiectCls;
