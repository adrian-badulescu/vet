...
import { ImprumutCls } from './imprumut.model';
...
export class ImprumutComponent extends Base implements OnInit {
  ...
  list: ImprumutCls[];
  columns: any[];
  item: ImprumutCls = new ImprumutCls();
  selectedItems: ImprumutCls[];
  value: Date;
  ...
  ngOnInit() {
    this.service.entity = this.entityapi = 'imprumut';
    this.validationform = this.formBuilder.group({
      ...
      efectiveRate: ['', [Validators.required]],
  ...
  edit() {
    ...
    this.submitted = false;
    this.item = JSON.parse(JSON.stringify(this.selectedItems)) as ImprumutCls;
