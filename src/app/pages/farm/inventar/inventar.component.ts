...
import { InventarCls } from './inventar.model';
...
export class InventarComponent extends Base implements OnInit {
  ...
  list: InventarCls[];
  columns: any[];
  item: InventarCls = new InventarCls();
  selectedItems: InventarCls[];
  value: Date;
  ...
  ngOnInit() {
    this.service.entity = this.entityapi = 'inventar';
  ...
  edit() {
    ...
    this.submitted = false;
    this.item = JSON.parse(JSON.stringify(this.selectedItems)) as InventarCls;
