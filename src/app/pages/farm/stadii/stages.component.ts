...
import { StagesCls } from './stages.model';
...
export class StagesComponent extends Base implements OnInit {
  ...
  list: StagesCls[];
  columns: any[];
  item: StagesCls = new StagesCls();
  selectedItems: StagesCls[];
  value: Date;
  ...
  ngOnInit() {
    this.canAdd= false;
    this.service.entity = this.entityapi = 'stages';
    this.validationform = this.formBuilder.group({
      ...
      daysStageEnd: ['', [Validators.required]],
      parentM: ['', [Validators.required]],
      parentF: ['', [Validators.required]]
    });
  ...
  edit() {
    ...
    this.submitted = false;
    this.item = JSON.parse(JSON.stringify(this.selectedItems)) as StagesCls;
