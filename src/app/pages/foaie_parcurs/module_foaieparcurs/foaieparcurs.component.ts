...
import { FoaieParcursCls } from './foaieparcurs.model';
import { FoaieParcursService } from './foaieparcurs.service';
import { BaseService } from '../../_services/base.service';

@Component({
    templateUrl: 'foaieparcurs.component.html',
    providers: [EwoService, BaseService, FoaieParcursService]
})
export class FoaieParcursComponent extends Base implements OnInit {

    breadCrumbItems: Array<{}>;

    Driver: Array<string> = ['A', 'B', 'C', '...'];
    FuelType: Array<string> = ['Benzina', 'Motorina', 'Kerosen', 'H2O', '...',];

    list: FoaieParcursCls[];
    columns: any[];
    item: FoaieParcursCls = new FoaieParcursCls();
    selectedItems: FoaieParcursCls[];
    value: Date;
    ...
    ngOnInit() {
        this.service.entity = this.entityapi = 'foaieparcurs';
    ...
    edit() {
        ...
        this.submitted = false;
        this.item = JSON.parse(JSON.stringify(this.selectedItems)) as FoaieParcursCls;
