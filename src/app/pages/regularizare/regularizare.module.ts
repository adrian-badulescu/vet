import { RegularizareRoutingModule } from './regularizare-routing.module';
...
@NgModule({
  declarations: [RegularizareComponent],
  imports: [
    CommonModule, RegularizareRoutingModule,
    TabsModule,
...
export class RegularizareModule { }
