...
import { Table, SearchResult } from './cerereoferta.model';

// import { tableData } from './data';

import { SortDirection } from '../inventory/inventory-sortable.directive';
...
function matches(tables: Table, term: string, pipe: PipeTransform) {
    ...
    return tables.nr.toLowerCase().includes(term)
        || tables.data.toLowerCase().includes(term)
        || tables.serie.toLowerCase().includes(term)
...
export class InventoryService {
    ...
    private inventoryDb = environment.server.url+"/api/db-queries/execute/cerereoferta";
