...
import { Table, SearchResult } from './inventory.model';

// import { tableData } from './data';

import { SortDirection } from './inventory-sortable.directive';
...
export class InventoryService {
    ...
    // gets all items from dbo inventory
    public findAllItems() {
        return this.httpClient.get(this.inventoryDb).pipe(
